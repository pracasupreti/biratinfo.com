        ...
        <section className='w-full px-4 lg:px-16 md:px-5 py-10'>
            <div className='max-w-8xl mx-auto md:mx-12 lg:mx-20 flex flex-col gap-10'>
                <div className='flex flex-col gap-2'>
                    <p className='text-text-color font-orienta text-[18px] font-[700]'>सुरक्षा</p>
                    ...
                    {employment.map((item) => (
                        <div className='flex flex-col gap-3 group' key={item.index}>
                            ...
                            <div className='flex gap-2'>
                                {item.index === 3 && (
                                    <span className='font-roboto font-semibold text-[14px] bg-black text-white px-2 rounded-lg'>
                                        EXCLUSIVE
                                    </span>
                                )}
                                <p className='text-[#808080] font-roboto font-medium text-[14px]'>{item.miniTitle}</p>
                            </div>

                            <h3 className='font-ibm_plex_serif font-bold text-[16px] md:text-[18px] leading-snug text-text-color line-clamp-2 hover:underline cursor-pointer'>
                                {item.title}
                            </h3>
