        ...
        <div className="w-full px-4 lg:px-16 md:px-5 py-10">
            <div className="max-w-8xl mx-auto md:mx-12 lg:mx-20 flex flex-col gap-10">
                <div className="flex flex-col gap-2">
                    <p className="text-text-color font-orienta text-[18px] font-[700]">खेलकुद</p>
                ...
                <div className="flex flex-col lg:flex-row gap-12 items-stretch">
                    ...
                    <div className="flex-1 flex flex-col gap-5 h-full justify-between">
                        <div>
                            ...
                            <p className="font-ibm_plex_serif font-bold text-[16px] md:text-[18px] lg:text-[20px] cursor-pointer text-text-color mt-4 hover:underline line-clamp-1">
                                आइसीसी यू-१९ विश्वकप एसिया छनोट अन्तर्गत नेपाल र अफगानिस्तानबीचको खेल रद्द
                            </p>
                            <p className="text-[#808080] font-ibm_plex_serif font-medium text-sm sm:text-base lg:text-[16px] mt-2">
                        ...
                        <p className="text-[#808080] font-roboto font-medium text-[16px] flex items-center gap-2">
                        ...
                        {Sports.map((item, index) => (
                            <div key={index} className="flex flex-col sm:flex-row gap-4 group items-start">
                                ...
                                <div className="flex flex-col gap-1 sm:w-[60%]">
                                    <p className="font-ibm_plex_serif font-semibold text-[16px] md:text-[18px] cursor-pointer text-text-color hover:underline line-clamp-1">
                                        {item.title}
                                    </p>
                                    <p className="text-[#808080] font-ibm_plex_serif font-medium text-[16px] line-clamp-2">
                                        {item.description}
                                    </p>
                                    <p className="text-[#808080] font-roboto font-medium text-[16px] mt-2 flex items-center gap-2">
