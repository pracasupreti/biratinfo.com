...
export function PostTable({
    ...
    // Memoized filtered and sorted posts for better performance
    ...
    const getStatusBadgeClass = useCallback((status: string) => {
        const statusClasses = {
            ...
            scheduled: "bg-orange-500/10 text-orange-700 border-orange-300 px-1 text-[10px]",
                        ...
                        <Card key={post._id} className="hover:shadow-md transition-all duration-200 hover:border-primary/20">
                            ...
                            <CardContent className={`hidden lg:grid ${isEditable ? 'grid-cols-14' : 'grid-cols-12'} gap-4 px-4 py-3 items-center`}>
                                ...
                                <div className="col-span-3 space-y-1">
                                    ...
                                    {post.isNepali && (
                                        <Badge variant="secondary" className="text-xs">नेपाली</Badge>
                                    )}
                                </div>
